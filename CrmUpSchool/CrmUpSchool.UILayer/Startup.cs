...
namespace CrmUpSchool.UILayer
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.ContainerDependencies();  //DIContainer için  scopedler 
            ...
            services.AddMvc(config =>      //Kullanýcý sisteme giriþ yapmaya zorunlu tüm sayfalara eriþim engeli oluþturduk
            {
